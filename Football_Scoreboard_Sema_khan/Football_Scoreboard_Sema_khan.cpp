...
public:
	...
	{               //DISPLAY BOARD******
		...
		cout << "#" << "\t\t" << color << home.getName() << "\t\t" << visitor.getName() << "\t\t" << endl;
		cout << "#" << color << "\t\t" << "Scores" << "\t" << score << home.getScore() << "\t" << visitor.
			getScore() << "\t\t"<< endl;
		cout << "#" << color << "\t\t" << "Coach" << "\t" << home.getCoach_Name() << reset << "\t" << color << visitor.
			getCoach_Name() << "\t\t"<< endl;
		cout << "#" << color << "\t\t" << "Cities" << "\t" << home.getHome_City() << reset << "\t" << color << visitor.
			getHome_City() << "\t\t" << endl;
		cout << "#" << color << "\t\t"  << "Timeout" << "\t\t" << home.getTimeout_Count() << reset << "\t" << endl; //"\t\t" << endl;
